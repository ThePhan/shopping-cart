              ...
              <table>
                <tbody>
                  <tr>
                     ...
                     <td><b> Id: </b> {this.props.data.id} <br />
                     <b> Name product: </b>{this.props.data.nameProduct} <br />
                     <b> Price: </b>{this.props.data.price} <br />
                     <b> describe: </b>{this.props.data.describe} <br />
                  </td>
                  </tr>
                </tbody>

              </table>
              <Button id="spaceButton" onClick={this.handleBuyButton} bsStyle="warning" bsSize="small"><Glyphicon glyph="pencil"/> Buy </Button>
